...
|~~Miro~~|Collaboration tool: Whiteboarding|Miro is no longer considered suitable for UK Government or NHS use. Please use Mural instead.<br />Avoid personal or sensitive data<br />*Please consider using Mural instead which has some corporate support and licensing.*|Web browser|Internal/External|
...
| Miro                                    | Collaboration tool: Whiteboarding      | Due to security and privacy concerns, this tool is not considered suitable for UK Government or NHS use. Please use the similar Mural service if needed. |
